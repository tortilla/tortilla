...
class Client(object):
    ...
    def _request(self, method, url, path=(), params=None, headers=None,
        ...
        self._log(debug_messages['request'], debug,
                  method=method.__name__.lower(), url=url, params=params,
                  data=data)

        r = method(url, params=params, headers=headers, data=data)
    ...
    def get(self, **options):
        return self._request(requests.get, **options)

    def post(self, **options):
        return self._request(requests.post, **options)

    def put(self, **options):
        return self._request(requests.put, **options)

    def delete(self, **options):
        return self._request(requests.delete, **options)
